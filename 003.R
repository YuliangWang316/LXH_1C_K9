...
setwd("e:/K9homer/")
LK9KO4 <- fread('LK9KO4_new_AnLWT12_new_refpoint_binsize10_5k',header = F)
CK9KO2 <- fread('CK9KO2_new_AnLWT16_new_refpoint_binsize10_5k',header = F)
K9me2KO4 <- fread('K9me2KO4_new_JBLWT14_new_refpoint_binsize10_5k',header = F)
...
filnal_scaler_LK9KO4_KO$mean_signal<-filnal_scaler_LK9KO4_KO$mean_signal +2
filnal_scaler_LK9KO4_WT$mean_signal<-filnal_scaler_LK9KO4_WT$mean_signal +9
...
filnal_scaler_CK9KO2_WT$mean_signal<-filnal_scaler_CK9KO2_WT$mean_signal +9
...
filnal_scaler_K9me2KO4_WT$mean_signal<-filnal_scaler_K9me2KO4_WT$mean_signal +13
filnal_scaler_K9me2KO4<-rbind(filnal_scaler_K9me2KO4_KO,filnal_scaler_K9me2KO4_WT)
filnal_scaler_K9me2KO4$sample<-factor(filnal_scaler_K9me2KO4$sample,levels = c("K9me2KO4","JB_LWT14"))
