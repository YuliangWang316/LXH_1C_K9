...
setwd("e:/K9homer/")
LK9KO4 <- fread('LK9KO4_new2_AnLWT12_new2_ignoreDuplicates_refpoint_binsize10_5k',header = F)
CK9KO2 <- fread('CK9KO2_new2_AnLWT16_new2_ignoreDuplicates_refpoint_binsize10_5k',header = F)
K9me2KO4 <- fread('K9me2KO4_new2_JBLWT14_new2_ignoreDuplicates_refpoint_binsize10_5k',header = F)
...
filnal_scaler_LK9KO4_KO$mean_signal<-filnal_scaler_LK9KO4_KO$mean_signal +1
filnal_scaler_LK9KO4_WT$mean_signal<-filnal_scaler_LK9KO4_WT$mean_signal +3.78
...
filnal_scaler_CK9KO2_WT$mean_signal<-filnal_scaler_CK9KO2_WT$mean_signal +3.93
...
filnal_scaler_K9me2KO4_WT$mean_signal<-filnal_scaler_K9me2KO4_WT$mean_signal +3.88
